...
with tf.device('/cpu:0'):
    ...
    def model(x_crop, y_, is_train, reuse):
        ...
        with tf.variable_scope("model", reuse=reuse):
            ...
            net1=[]
            for i in range(2):
                net1.append(tl.layers.BinaryConv2d(net[:,:,:,i::2], 128, (4, 4), (2, 2), padding='SAME', b_init=None, name='cnn1_'+str(i+1)))
            ...
            net2=[]
            for i in range(8):
                net2.append(tl.layers.BinaryConv2d(net[:,:,:,i::8], 64, (3, 3), (1, 1), padding='SAME', b_init=None, name='cnn2_'+str(i+1)))
            ...
            #net = tl.layers.BinaryConv2d(net, 128, (1, 1), (1, 1), padding='SAME', b_init=None, name='cnn3_1') 
            #net = tl.layers.BatchNormLayer(net, act=tl.act.htanh, is_train=is_train, name='bn3_1')
            #net = tl.layers.SignLayer(net)
            #net.outputs = (net.outputs+1)/2

            #net = tl.layers.BinaryConv2d(net, 128, (1, 1), (1, 1), padding='SAME', b_init=None, name='cnn3_2') 
            ...
            net4=[]
            for i in range(4):
                net4.append(tl.layers.BinaryConv2d(net[:,:,:,i::4], 128, (2, 2), (2, 2), padding='SAME', b_init=None, name='cnn4_'+str(i+1)))
            ...
            #net = tl.layers.BinaryConv2d(net, 128, (1, 1), (1, 1), padding='SAME', b_init=None, name='cnn5_1') 
            #net = tl.layers.BatchNormLayer(net, act=tl.act.htanh, is_train=is_train, name='bn5_1')
            #net = tl.layers.SignLayer(net)
            #net.outputs = (net.outputs+1)/2  

            #net = tl.layers.BinaryConv2d(net, 128, (1, 1), (1, 1), padding='SAME', b_init=None, name='cnn5_2') 
            ...
            net6=[]
            for i in range(16):
                net6.append(tl.layers.BinaryConv2d(net[:,:,:,i::16], 128, (3, 3), (1, 1), padding='VALID', b_init=None, name='cnn6_'+str(i+1)))
            ...
            net7=[]
            for i in range(4):
                net7.append(tl.layers.BinaryConv2d(net[:,:,:,i::4], 256, (1, 1), (1, 1), padding='SAME', b_init=None, name='cnn7_'+str(i+1)))
            ...
            net8=[]
            for i in range(8):
                net8.append(tl.layers.BinaryConv2d(net[:,:,:,i::8], 128, (2, 2), (2, 2), padding='SAME', b_init=None, name='cnn8_'+str(i+1)))
            ...
            #net = tl.layers.BinaryConv2d(net, 256, (1, 1), (1, 1), padding='SAME', b_init=None, name='cnn9_1') 
            #net = tl.layers.BatchNormLayer(net, act=tl.act.htanh, is_train=is_train, name='bn9_1')
            #net = tl.layers.SignLayer(net)
            #net.outputs = (net.outputs+1)/2

            #net = tl.layers.BinaryConv2d(net, 256, (1, 1), (1, 1), padding='SAME', b_init=None, name='cnn9_2') 
            #net = tl.layers.BatchNormLayer(net, act=tl.act.htanh, is_train=is_train, name='bn9_2')
            #net = tl.layers.SignLayer(net)
            #net.outputs = (net.outputs+1)/2

            #net = tl.layers.BinaryConv2d(net, 256, (1, 1), (1, 1), padding='SAME', b_init=None, name='cnn9_3') 
            ...
            net10=[]
            for i in range(8):
                net10.append(tl.layers.BinaryConv2d(net[:,:,:,i::8], 128, (2, 2), (1, 1), padding='VALID', b_init=None, name='cnn10_'+str(i+1)))
            ...
            net = tl.layers.BinaryConv2d(net, 512, (1, 1), (1, 1), padding='VALID', b_init=None, name='cnn11_1') 
            net = tl.layers.BatchNormLayer(net, act=tl.act.htanh, is_train=is_train, name='bn11_1')
            net = tl.layers.SignLayer(net)
            net.outputs = (net.outputs+1)/2

            #net = tl.layers.BinaryConv2d(net, 512, (1, 1), (1, 1), padding='VALID', b_init=None, name='cnn12_1') 
            ...
            #net = tl.layers.BinaryConv2d(net, 384, b_init=None, name='d1relu')
